...
level2_balance <- computeWeightedMean(btsagg1, 'balance', 'weight', c("date_qtrly","group", "sClass"))
...
level3_balance <- computeWeightedMean(btsagg2, 'balance', 'weight', c("date_qtrly", "sClass"))
